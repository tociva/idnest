#!/usr/bin/env bash
#
# Idnest identity bootstrap for Linux (apt/yum Postgres with a `postgres` OS user).
...
#
# Usage: ./scripts/setup/setup-idnest-db-linux.sh
#
set -eu
...
echo "==> Idnest Hydra and Kratos setup complete."
